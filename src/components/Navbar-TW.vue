<template>
  <div class="w-full bg-transparent sticky top-0 px-10 py-6 flex justify-between place-content-center z-50 transition-all transform duration-500" id="header">
    ...
    <div class="flex flex-row justify-center gap-4">
      ...
      <router-link to="/category" class="nav-item text-gray-800 text-center p-2 font-body font-bold text-lg cursor-pointer border-b-2 border-transparent transform transition-all duration-300 hover:border-gray-800">Ekonomi</router-link>
      <router-link to="/category" class="nav-item text-gray-800 text-center p-2 font-body font-bold text-lg cursor-pointer border-b-2 border-transparent transform transition-all duration-300 hover:border-gray-800">Sosial</router-link>
    </div>
  </div>
</template>
